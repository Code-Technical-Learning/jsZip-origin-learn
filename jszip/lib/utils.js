...
exports.transformTo = function (outputType, input) {
    ...
    let inputType = exports.getTypeOf(input);
    let result = transform[inputType][outputType](input);
    return result;
};
...
exports.checkSupport = function (type) {
    let supported = support[type.toLowerCase()];
    if (!supported) {
 ...
 * @private
 * @param {...Object} let_args All objects to merge.
...
exports.prepareContent = function (
    ...
    let promise = external.Promise.resolve(inputData).then(function (data) {
        let isBlob =
            support.blob &&
    ...
    return promise.then(function (data) {
        let dataType = exports.getTypeOf(data);
