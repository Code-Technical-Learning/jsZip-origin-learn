 ...
 */
let decToHex = function (dec, bytes) {
    let hex = "",
        i;
    for (i = 0; i < bytes; i++) {
 ...
 */
let generateUnixExternalFileAttr = function (unixPermissions, isDir) {
 ...
 * Bit 5     Archive
 */
let generateDosExternalFileAttr = function (dosPermissions) {
    // the dir flag is already set for compatibility
    return (dosPermissions || 0) & 0x3f;
};

/**
 * Generate the letious parts used in the construction of the final zip file.
 ...
 */
let generateCentralDirectoryEnd = function (
    entriesCount,
    centralDirLength,
    localDirLength,
    comment,
    ...
    let dirEnd = "";
    let encodedComment = utils.transformTo("string", encodeFileName(comment));
 ...
 */
let generateDataDescriptors = function (streamInfo) {
    let descriptor = "";
    descriptor =
...
ZipFileWorker.prototype.flush = function () {
    ...
    let dirEnd = generateCentralDirectoryEnd(
